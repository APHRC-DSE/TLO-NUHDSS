...
class RunAnalysisCo(BaseScenario):
    def __init__(self):
        super().__init__(
            ...
            initial_population_size=20000,  # selected size for the Tim C at al. 2023 paper: 250K
    ...
    def log_configuration(self):
        return {
            'filename': 'run_simulation_nuhdss',  # <- (specified only for local running)
    ...
    def modules(self):
        return [
            ...
            contraception_nuhdss_slums.ContraceptionSlums(resourcefilepath=self.resources,
